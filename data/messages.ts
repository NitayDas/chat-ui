...
export const messages: ChatMessage[] = [
  ...
  },
  {
    id: 3,
    role: "user",
    content: "I have a form with multiple inputs and I'm not sure if I should use useState for each field or one object.",
    emotions: [
  ...
  },
  {
    id: 4,
    role: "assistant",
    content: "Great question! For multiple related form fields, I'd recommend using a single useState with an object. It's cleaner and easier to manage. Here's a quick example:\n\n```javascript\nconst [formData, setFormData] = useState({\n  name: '',\n  email: '',\n  message: ''\n});\n```",
    emotions: [
